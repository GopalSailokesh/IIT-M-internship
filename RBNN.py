...
data = idx2np.convert_from_file(
    r"/home/saurav/Lokesh/IIT-M-internship/train-images.idx3-ubyte"
)
labels = idx2np.convert_from_file(
    r"/home/saurav/Lokesh/IIT-M-internship/train-labels.idx1-ubyte"
)
...
plt.savefig("/home/saurav/Lokesh/IIT-M-internship/accuracy_plot.png", dpi=300)
